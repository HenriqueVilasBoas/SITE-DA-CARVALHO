      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
          {mockServices.map((service) => {
            ...
            return (
              <div key={service.id} className="network-card hover:shadow-xl">
                <div className="flex items-center gap-4 mb-4">
                  <div className="bg-[#CACAFC] p-3 rounded-lg">
                    <IconComponent className="text-[#004534]" size={24} />
                  </div>
                  <h4 className="heading-3 text-lg">
                    {service.title[language]}
                  </h4>
                </div>
                <p className="network-card-content">
